...
Server.prototype.handleConnection = function(socket) {
  ...
  socket.on('create', function(instance, cols, rows, func) {
    console.log("Instance :"+instance);
    return session.handleCreate(instance, cols, rows, func);
  });
...
Session.prototype.handleCreate = function(instance, cols, rows, func) {
  var self = this
    , terms = this.terms
